...
# Make sure to run "sudo updatedb" prior to running the script.
# How To Run Script: sudo wget https://raw.githubusercontent.com/5ur35n/log4j-test/main/test.sh -q -O - |bash
